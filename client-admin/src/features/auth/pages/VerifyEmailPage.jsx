    ...
    return (
        ...
        <div className="relative w-full max-w-sm mx-auto min-h-screen md:min-h-0 flex flex-col">
            ...
            <div className="relative z-10 flex flex-col items-center px-7 pt-10 pb-10 gap-4 flex-1">
                <div className="rounded-full border-[3px] bg-white overflow-hidden flex items-center justify-center shadow-md" style={{ borderColor: "#f0c030", width: 110, height: 110 }}>
                ...
                {status === "success" && (
                <div className="flex flex-col items-center gap-3">
                    <div className="w-14 h-14 rounded-full flex items-center justify-center" style={{ background: "#f5c518" }}>
                ...
                <div className="flex flex-col items-center gap-3">
                    ...
                    <a href="/" className="w-full py-3.5 rounded-2xl font-semibold text-white text-base shadow-md flex items-center justify-center active:scale-95 transition-transform" style={{ background: "linear-gradient(135deg,#f5c518 0%,#e6a800 100%)" }}>
                    Volver al Login
                    </a>
                </div>
                )}
