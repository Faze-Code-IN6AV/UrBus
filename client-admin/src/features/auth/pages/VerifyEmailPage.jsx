            ...
            <div className="relative w-full max-w-sm mx-auto min-h-screen md:min-h-0 flex flex-col">
                <div className="relative overflow-hidden md:rounded-3xl md:shadow-xl flex-1 flex flex-col" style={{ background: "#eaf4fb" }}>
                    ...
                    <div className="relative z-10 flex flex-col items-center px-7 pt-10 pb-10 gap-4 flex-1">
                        ...
                        <div className="rounded-full border-[3px] bg-white overflow-hidden flex items-center justify-center shadow-md"
                            style={{ borderColor: "#f0c030", width: 110, height: 110 }}>
                            <img src={urbuLogo} alt="UrBus Logo" className="w-24 h-24 object-contain" />
                        </div>

                        <h1 className="text-2xl font-bold text-gray-800 text-center">Verificación de correo</h1>
                        ...
                        {status === "success" && (
                            <div className="flex flex-col items-center gap-3">
                                ...
                                <p className="text-center text-sm text-gray-700 font-medium">¡Correo verificado correctamente!</p>
                                <button
                                    onClick={() => navigate("/")}
